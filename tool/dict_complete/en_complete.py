...
def create_inverted_index_entity(namespath, outpath):
    ...
    index={}
    index=pickle.load(open('entity.pkl','rb'))
    size = 0
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n', '--names', dest='names', action='store', default='en_miss.txt',
                        help='path to the trimmed names file')
    parser.add_argument('-p', '--pickle', dest='pickle', action='store', default='entity1.pkl',
