...
model = ClassificationModel(
    TYPE, 'large/'+MODEL+'_output', num_labels=len(exist),use_cuda=True,args=model_args
)
...
#print('关系预测模型训练时间：',train_time)
print('验证集关系预测时间：',valid_time)
print('测试集关系预测时间：',test_time)