...
def get_args(mode='train'):
    ...
    if mode == 'predict':
         ...
         parser.add_argument("--input_file",
                        default='data10_small/test.json',
                        type=str,
                        help="the path of predict file!")
         parser.add_argument("--output_file",
                        default='./final_result_all/test_neg10.txt',
                        type=str,
                        help="the path of predict file!")
